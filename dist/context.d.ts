...
export declare const ThemeProvider: ({ children, defaultTheme, storage, storageKey, theming, breakpoints, }: ThemeProviderProps) => import("react/jsx-runtime").JSX.Element;
